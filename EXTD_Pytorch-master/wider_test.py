...
def get_data():
    ...
    if subset == 'val':
        wider_face = sio.loadmat(
            '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EXTD_Pytorch-master/eval_tools/ground_truth/wider_face_val.mat')
    else:
        wider_face = sio.loadmat(
            '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EXTD_Pytorch-master/eval_tools/ground_truth/wider_face_test.mat')
    ...
    save_path = '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EXTD_Pytorch-master/eval_tools/c'
...
if __name__ == '__main__':
    ...
    eval_wider(model_path)
    #evaluation()
    #eval_wider('./weights/nL1_AS55.pth')
