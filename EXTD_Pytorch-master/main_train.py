...
parser.add_argument('--save_folder',
                    default='./weights/default_train_script_2/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--pretrained', default='./weights/mobileFacenet_maxpool_v5_.pth', type=str, metavar='PATH',
...
if __name__ == '__main__':
    train()
    # if USE_NSML == False:
    #     eval_wider(os.path.join(args.save_folder, './weights/sfd_face_default.pth'))
