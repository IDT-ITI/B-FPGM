...
def get_data():
    ...
    if subset == 'val':
        wider_face = sio.loadmat(
            '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EResFD-main/eval_tools/wider_ground_truth/wider_face_val.mat')
    else:
        wider_face = sio.loadmat(
            '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EResFD-main/eval_tools/wider_face_test.mat')
    ...
    save_path = '/home/kaparinos/Projects/Lightweight-Face-Detector-Internal/EResFD-main/eval_tools/a'
    # save_path = 'eval_tools/s3fd_res_retrain_{}'.format(subset)
...
def eval_wider(model_name):
    ...
    if isinstance(model_name, str):
        ...
        net.load_state_dict(torch.load(model_name),
                            strict=True)  # was strict=True, but I changed it to False to load the model with masks in buffer

        # net = torch.jit.load("scripted_model.pt")
    else:
        net = model_name
    net.eval()
    with torch.no_grad():
